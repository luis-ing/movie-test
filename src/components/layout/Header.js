            ...
            <nav aria-label="Global" className="mx-auto flex items-center justify-between p-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                        ...
                        <Link to="/movies" className="text-sm font-semibold leading-0 flex">
                            <VideoCameraIcon aria-hidden="true" className="h-5 w-5 flex-none text-gray-400" />
                            <div style={{ paddingLeft: 6 }}>Peliculas</div>
                        </Link>
                        <Link to="/series" className="text-sm font-semibold leading-0 flex">
                            <TvIcon aria-hidden="true" className="h-5 w-5 flex-none text-gray-400" />
                            <div style={{ paddingLeft: 6 }}>Series</div>
                        </Link>
                                ...
                                <div className="p-4">
                                    ...
                                    >
                                        <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                            <CursorArrowRaysIcon aria-hidden="true" className="h-6 w-6 text-gray-600 group-hover:text-gray-400" />
                                        </div>
